...
public class FatCardioWorkout extends WorkoutActivity {
    ...
    protected void setVideos() {
        videos = new String[]{
                getResources().getString(R.string.fat_ex_1_url),
                getResources().getString(R.string.fat_ex_2_url),
                getResources().getString(R.string.fat_ex_3_url),
                getResources().getString(R.string.fat_ex_4_url),
                getResources().getString(R.string.fat_ex_5_url),
                getResources().getString(R.string.fat_ex_6_url),
                getResources().getString(R.string.fat_ex_7_url),
                getResources().getString(R.string.fat_ex_8_url),
                getResources().getString(R.string.fat_ex_9_url),
                getResources().getString(R.string.fat_ex_10_url),
                " "
        };
    }
